...
array< map<float,pack_t>* , 16> slalomparams::getParams(){
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		...
		{0.25, {0.009,0.008,  6500,92.4,     30,   0.25,    0.25,    0.25,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		...
		{0.25, {0.009,0.011,  6500,92.4,     30,   0.25,    0.25,    0.25,     0.0}},
		{ 0.3, {0.002,0.010, 10000,92.0,     30,    0.3,     0.3,     0.3,     0.0}},
	};
	
	static map<float, pack_t> SLALOM90_RIGHT = {
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.023,0.034,   3000,91.0,     30,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.023,0.033,   3000,90.0,     30,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.000,0.000,   1600, 182,     60,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.000,0.000,   1600, 180,     60,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.020,0.040,   6000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.027,0.025,   5000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.027,0.023,   5000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
		{ 0.5, {0.020,0.000,   8000,46.5,     15,    0.5,     0.5,     0.5,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.040,0.030,   5000, 135,     45,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.030,0.050,   5000, 137,     45,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.050,0.050,   5000, 137,     45,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.029, 0.029, 10000,  95,     30,    0.3,     0.3,     0.3,     0.0}},
