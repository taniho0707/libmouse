...
array< map<float,pack_t>* , 16> slalomparams::getParams(){
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		...
		{0.25, {0.005,0.013,  6500,92.0,     30,   0.25,    0.25,    0.25,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.013,0.029,   3000,91.0,     30,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.013,0.023,   3000,90.0,     30,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.000,0.000,   1600, 184,     60,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.022,0.040,   6000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.021,0.040,   6000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.032,0.005,   5000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.032,0.003,   5000,47.0,     15,    0.3,     0.3,     0.3,     0.0}},
		{ 0.5, {0.020,0.000,   8000,46.5,     15,    0.5,     0.5,     0.5,     0.0}},
	...
	//  { vel, {d_bef, d_aft, a_rad, deg, cnsdeg, in_vel, out_vel, min_vel, acc_lin}},
		{ 0.3, {0.028, 0.027, 10000,  95,     30,    0.3,     0.3,     0.3,     0.0}},
